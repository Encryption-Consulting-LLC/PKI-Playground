...
/**
 * Single-icon theme switcher — reads/writes the same persisted theme store
 * key as the operator app (STORAGE_KEYS.theme), so a preference set in one
 * app applies in the other (same origin, same localStorage).
 */
